...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0046R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C0046R.styleable.ActionBar, C0046R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0046R.styleable.ActionBar_height, 0));
        a.recycle();
