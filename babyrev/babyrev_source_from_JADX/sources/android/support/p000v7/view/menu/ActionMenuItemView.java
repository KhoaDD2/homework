...
import android.support.p000v7.widget.ForwardingListener;
import android.support.p000v7.widget.TooltipCompat;
...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0046R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0046R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
