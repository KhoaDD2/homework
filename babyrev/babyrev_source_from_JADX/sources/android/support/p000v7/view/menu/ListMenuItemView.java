...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0046R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0046R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0046R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0046R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0046R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0046R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes((AttributeSet) null, new int[]{16843049}, C0046R.attr.dropDownListViewStyle, 0);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0046R.C0048id.title);
        int i = this.mTextAppearance;
        if (i != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0046R.C0048id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0046R.C0048id.submenuarrow);
        ImageView imageView = this.mSubMenuArrowView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0046R.C0048id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0046R.C0048id.content);
    }
