...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int weight = array.getInt(array.hasValue(C0008R.styleable.FontFamilyFont_fontWeight) ? C0008R.styleable.FontFamilyFont_fontWeight : C0008R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean isItalic = 1 == array.getInt(array.hasValue(C0008R.styleable.FontFamilyFont_fontStyle) ? C0008R.styleable.FontFamilyFont_fontStyle : C0008R.styleable.FontFamilyFont_android_fontStyle, 0);
        int ttcIndexAttr = array.hasValue(C0008R.styleable.FontFamilyFont_ttcIndex) ? C0008R.styleable.FontFamilyFont_ttcIndex : C0008R.styleable.FontFamilyFont_android_ttcIndex;
        String variationSettings = array.getString(array.hasValue(C0008R.styleable.FontFamilyFont_fontVariationSettings) ? C0008R.styleable.FontFamilyFont_fontVariationSettings : C0008R.styleable.FontFamilyFont_android_fontVariationSettings);
        int ttcIndex = array.getInt(ttcIndexAttr, 0);
        int resourceAttr = array.hasValue(C0008R.styleable.FontFamilyFont_font) ? C0008R.styleable.FontFamilyFont_font : C0008R.styleable.FontFamilyFont_android_font;
