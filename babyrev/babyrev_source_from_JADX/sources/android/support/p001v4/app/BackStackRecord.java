...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    @Nullable
    String mName;
    ArrayList<C0083Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0083Op {
        ...
        C0083Op(int cmd2, Fragment fragment2) {
            this.cmd = cmd2;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0083Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
    ...
    private void doAddOp(int containerViewId, Fragment fragment, @Nullable String tag, int opcmd) {
        ...
        addOp(new C0083Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0083Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0083Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0083Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0083Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0083Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0083Op(8, fragment));
        return this;
    }
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0083Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0083Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0083Op removeOp = new C0083Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new C0083Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new C0083Op(9, oldPrimaryNav));
                    opNum++;
    ...
    private static boolean isFragmentPostponed(C0083Op op) {
