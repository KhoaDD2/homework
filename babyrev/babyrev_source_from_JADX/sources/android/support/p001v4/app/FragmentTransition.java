...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.C0083Op op, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop, boolean isReorderedTransaction) {
        int containerId;
        boolean setFirstOut;
        boolean wasRemoved;
        boolean wasAdded;
        ...
        BackStackRecord.C0083Op op2 = op;
