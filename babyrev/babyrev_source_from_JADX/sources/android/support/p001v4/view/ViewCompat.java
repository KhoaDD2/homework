...
import android.support.annotation.C0070Px;
...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0070Px int start, @C0070Px int top, @C0070Px int end, @C0070Px int bottom) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo115to = 1.0d) float value) {
        view.setAlpha(value);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0008R.C0010id.tag_unhandled_key_listeners);
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0008R.C0010id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0008R.C0010id.tag_unhandled_key_listeners, viewListeners2);
        }
