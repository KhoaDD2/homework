...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public void delete(int r5) {
        /*
            ...
            int[] r0 = r4.mKeys
            int r1 = r4.mSize
            int r0 = android.support.p001v4.util.ContainerHelpers.binarySearch((int[]) r0, (int) r1, (int) r5)
        ...
        L_0x0017:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.util.SparseArrayCompat.delete(int):void");
    }
