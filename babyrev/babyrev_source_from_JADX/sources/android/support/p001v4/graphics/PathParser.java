    ...
    public static class PathDataNode {
            ...
            while (k2 < fArr.length) {
                switch (cmd) {
                    ...
                    case 'a':
                        ...
                        float f12 = fArr[k2 + 6] + currentY2;
                        float f13 = fArr[k2 + 0];
                        float f14 = fArr[k2 + 1];
                        float currentY5 = fArr[k2 + 2];
                        float currentX5 = currentX2;
                        k = k2;
                        drawArc(path, currentX2, currentY2, f11, f12, f13, f14, currentY5, fArr[k2 + 3] != 0.0f, fArr[k2 + 4] != 0.0f);
                    ...
                    case 't':
                        ...
                        float ctrlPointY7 = currentY2 + reflectiveCtrlPointY5;
                        currentX2 += fArr[k2 + 0];
                        currentY2 += fArr[k2 + 1];
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (i < numSegments) {
                ...
                double d4 = q1y;
                double d5 = q2y;
                p.cubicTo((float) q1x, (float) q1y, (float) (anglePerSegment3 - (alpha * ep2x)), (float) q2y, (float) anglePerSegment3, (float) e2y);
                eta12 = eta2;
