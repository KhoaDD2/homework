...
public class Activity {
    public static void initActivity(MainActivity ctx) {
        ...
        String[] lines = FC.ec(FC.dec(mainActivity.getString(R.string.s1)) + " " + FC.dec(mainActivity.getString(R.string.s2))).split("\n");
        ...
        while (true) {
            ...
            if (FC.ec(FC.dec(mainActivity.getString(R.string.s3)) + " " + FC.dec(mainActivity.getString(R.string.s2)) + "/" + lines[i] + "/maps").contains(FC.dec(mainActivity.getString(R.string.s4)))) {
                found2 = true;
                break;
            }
            i++;
        ...
        while (true) {
            if (it.hasNext()) {
                if (it.next().packageName.equals(FC.dec(mainActivity.getString(R.string.s5)))) {
                    found = true;
                    break;
                }
            } else {
        ...
        try {
            MainActivity.g1 = ((Boolean) Class.forName(FC.dec(mainActivity.getString(R.string.s7))).getMethod(FC.dec(mainActivity.getString(R.string.s8)), new Class[0]).invoke((Object) null, new Object[0])).booleanValue();
        } catch (Exception e) {
