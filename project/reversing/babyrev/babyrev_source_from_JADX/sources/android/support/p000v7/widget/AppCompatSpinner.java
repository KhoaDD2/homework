...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, (AttributeSet) null, C0046R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0046R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r9, android.util.AttributeSet r10, int r11, int r12, android.content.res.Resources.Theme r13) {
        /*
            ...
            r0.<init>()
            r8.mTempRect = r0
            int[] r0 = android.support.p000v7.appcompat.C0046R.styleable.Spinner
            r1 = 0
            android.support.v7.widget.TintTypedArray r0 = android.support.p000v7.widget.TintTypedArray.obtainStyledAttributes(r9, r10, r0, r11, r1)
            ...
            goto L_0x003e
        L_0x0023:
            int r3 = android.support.p000v7.appcompat.C0046R.styleable.Spinner_popupTheme
        ...
        L_0x0073:
            ...
            r3.<init>(r5, r10, r11)
            android.content.Context r5 = r8.mPopupContext
            int[] r6 = android.support.p000v7.appcompat.C0046R.styleable.Spinner
            android.support.v7.widget.TintTypedArray r1 = android.support.p000v7.widget.TintTypedArray.obtainStyledAttributes(r5, r10, r6, r11, r1)
            int r5 = android.support.p000v7.appcompat.C0046R.styleable.Spinner_android_dropDownWidth
            r6 = -2
            int r5 = r1.getLayoutDimension((int) r5, (int) r6)
            r8.mDropDownWidth = r5
            int r5 = android.support.p000v7.appcompat.C0046R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r5 = r1.getDrawable(r5)
            r3.setBackgroundDrawable(r5)
            int r5 = android.support.p000v7.appcompat.C0046R.styleable.Spinner_android_prompt
        ...
        L_0x00ab:
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r1 = r0.getTextArray(r1)
            if (r1 == 0) goto L_0x00c3
            android.widget.ArrayAdapter r3 = new android.widget.ArrayAdapter
            r5 = 17367048(0x1090008, float:2.5162948E-38)
            r3.<init>(r9, r5, r1)
            int r5 = android.support.p000v7.appcompat.C0046R.layout.support_simple_spinner_dropdown_item
        ...
        L_0x00d1:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v7.widget.AppCompatSpinner.<init>(android.content.Context, android.util.AttributeSet, int, int, android.content.res.Resources$Theme):void");
    }
