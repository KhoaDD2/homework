...
import android.support.p000v7.view.ViewPropertyAnimatorCompatSet;
...
import android.support.p000v7.widget.ActionBarContainer;
import android.support.p000v7.widget.ActionBarContextView;
import android.support.p000v7.widget.ActionBarOverlayLayout;
import android.support.p000v7.widget.DecorToolbar;
import android.support.p000v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0046R.C0048id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0046R.C0048id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0046R.C0048id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0046R.C0048id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0046R.styleable.ActionBar, C0046R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0046R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0046R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0046R.attr.actionBarWidgetTheme, outValue, true);
