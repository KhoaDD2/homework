    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0046R.C0048id.topPanel) {
                    topPanel = child;
                } else if (id == C0046R.C0048id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0046R.C0048id.contentPanel && id != C0046R.C0048id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
