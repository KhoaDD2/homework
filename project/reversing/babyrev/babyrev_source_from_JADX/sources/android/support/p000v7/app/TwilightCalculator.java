...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round(((double) (daysSince2000 - f20J0)) - arcLongitude);
        double d = trueAnomaly;
        double solarTransitJ2000 = ((double) (f20J0 + n)) + arcLongitude + (Math.sin((double) meanAnomaly) * 0.0053d) + (Math.sin(2.0d * solarLng) * -0.0069d);
