...
import android.support.p000v7.view.ContextThemeWrapper;
import android.support.p000v7.view.StandaloneActionMode;
import android.support.p000v7.view.SupportActionModeWrapper;
import android.support.p000v7.view.SupportMenuInflater;
import android.support.p000v7.view.WindowCallbackWrapper;
import android.support.p000v7.view.menu.ListMenuPresenter;
...
import android.support.p000v7.widget.ActionBarContextView;
import android.support.p000v7.widget.AppCompatDrawableManager;
import android.support.p000v7.widget.ContentFrameLayout;
import android.support.p000v7.widget.DecorContentParent;
import android.support.p000v7.widget.TintTypedArray;
import android.support.p000v7.widget.Toolbar;
import android.support.p000v7.widget.VectorEnabledTintResources;
import android.support.p000v7.widget.ViewStubCompat;
import android.support.p000v7.widget.ViewUtils;
...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private android.view.ViewGroup createSubDecor() {
        /*
            ...
            int[] r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r1)
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme_windowActionBar
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto L_0x01a5
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme_windowNoTitle
            r2 = 0
        ...
        L_0x002b:
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme_windowActionBarOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            r4 = 109(0x6d, float:1.53E-43)
            if (r1 == 0) goto L_0x0038
            r10.requestWindowFeature(r4)
        L_0x0038:
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme_windowActionModeOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            if (r1 == 0) goto L_0x0045
            r1 = 10
            r10.requestWindowFeature(r1)
        L_0x0045:
            int r1 = android.support.p000v7.appcompat.C0046R.styleable.AppCompatTheme_android_windowIsFloating
            boolean r1 = r0.getBoolean(r1, r2)
            r10.mIsFloating = r1
            r0.recycle()
            ...
            int r3 = android.support.p000v7.appcompat.C0046R.layout.abc_dialog_title_material
        ...
        L_0x0074:
            ...
            int r9 = android.support.p000v7.appcompat.C0046R.attr.actionBarTheme
        ...
        L_0x0098:
            ...
            int r9 = android.support.p000v7.appcompat.C0046R.layout.abc_screen_toolbar
            android.view.View r8 = r8.inflate(r9, r7)
            r5 = r8
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            int r8 = android.support.p000v7.appcompat.C0046R.C0048id.decor_content_parent
            android.view.View r8 = r5.findViewById(r8)
            android.support.v7.widget.DecorContentParent r8 = (android.support.p000v7.widget.DecorContentParent) r8
        ...
        L_0x00d6:
            ...
            int r3 = android.support.p000v7.appcompat.C0046R.layout.abc_screen_simple_overlay_action_mode
            android.view.View r3 = r1.inflate(r3, r7)
            android.view.ViewGroup r3 = (android.view.ViewGroup) r3
            r5 = r3
            goto L_0x00ed
        L_0x00e4:
            int r3 = android.support.p000v7.appcompat.C0046R.layout.abc_screen_simple
            android.view.View r3 = r1.inflate(r3, r7)
            android.view.ViewGroup r3 = (android.view.ViewGroup) r3
            r5 = r3
        L_0x00ed:
        ...
        L_0x00fc:
            r3 = r5
            android.support.v7.widget.FitWindowsViewGroup r3 = (android.support.p000v7.widget.FitWindowsViewGroup) r3
        ...
        L_0x0107:
            ...
            int r3 = android.support.p000v7.appcompat.C0046R.C0048id.title
            android.view.View r3 = r5.findViewById(r3)
            android.widget.TextView r3 = (android.widget.TextView) r3
            r10.mTitleView = r3
        L_0x0117:
            android.support.p000v7.widget.ViewUtils.makeOptionalFitsSystemWindows(r5)
            int r3 = android.support.p000v7.appcompat.C0046R.C0048id.action_bar_activity_content
            android.view.View r3 = r5.findViewById(r3)
            android.support.v7.widget.ContentFrameLayout r3 = (android.support.p000v7.widget.ContentFrameLayout) r3
        ...
        L_0x01a5:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v7.app.AppCompatDelegateImpl.createSubDecor():android.view.ViewGroup");
    }
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0046R.styleable.AppCompatTheme);
        a.getValue(C0046R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0046R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0046R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0046R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0046R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0046R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0046R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0046R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0046R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0046R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0046R.attr.actionBarTheme, outValue, true);
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0046R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0046R.attr.actionBarSize, outValue, true);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0046R.C0048id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    public final boolean shouldAnimateActionModeView() {
        /*
            ...
            if (r0 == 0) goto L_0x0010
            boolean r0 = android.support.p001v4.view.ViewCompat.isLaidOut(r0)
            if (r0 == 0) goto L_0x0010
            r0 = 1
            goto L_0x0011
        L_0x0010:
        ...
        L_0x0011:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v7.app.AppCompatDelegateImpl.shouldAnimateActionModeView():boolean");
    }
    ...
    public View createView(View parent, String name, @NonNull Context context, @NonNull AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String viewInflaterClassName = this.mContext.obtainStyledAttributes(C0046R.styleable.AppCompatTheme).getString(C0046R.styleable.AppCompatTheme_viewInflaterClass);
        ...
        if (!panelFeatureState.isOpen && !this.mIsDestroyed) {
            ...
            if (cb == null || cb.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(width, -2, panelFeatureState.f15x, panelFeatureState.f16y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(C0046R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0046R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != (localInsets.top == 0 ? insetTop : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0046R.color.abc_input_method_navigation_guard));
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0046R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0046R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0046R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0046R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0046R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0046R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public final android.view.ActionMode startAsSupportActionMode(ActionMode.Callback callback) {
            ...
            android.support.p000v7.view.ActionMode supportActionMode = AppCompatDelegateImpl.this.startSupportActionMode(callbackWrapper);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0046R.attr.homeAsUpIndicator});
