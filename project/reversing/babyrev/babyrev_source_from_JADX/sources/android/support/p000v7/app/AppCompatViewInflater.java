...
import android.support.p000v7.widget.AppCompatAutoCompleteTextView;
import android.support.p000v7.widget.AppCompatButton;
import android.support.p000v7.widget.AppCompatCheckBox;
import android.support.p000v7.widget.AppCompatCheckedTextView;
import android.support.p000v7.widget.AppCompatEditText;
import android.support.p000v7.widget.AppCompatImageButton;
import android.support.p000v7.widget.AppCompatImageView;
import android.support.p000v7.widget.AppCompatMultiAutoCompleteTextView;
import android.support.p000v7.widget.AppCompatRadioButton;
import android.support.p000v7.widget.AppCompatRatingBar;
import android.support.p000v7.widget.AppCompatSeekBar;
import android.support.p000v7.widget.AppCompatSpinner;
import android.support.p000v7.widget.AppCompatTextView;
import android.support.p000v7.widget.TintContextWrapper;
...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, boolean useAndroidTheme, boolean useAppTheme) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0046R.styleable.View, 0, 0);
        int themeId = 0;
        if (useAndroidTheme) {
            themeId = a.getResourceId(C0046R.styleable.View_android_theme, 0);
        }
        if (useAppTheme && themeId == 0 && (themeId = a.getResourceId(C0046R.styleable.View_theme, 0)) != 0) {
