...
import android.support.p000v7.widget.MenuItemHoverListener;
import android.support.p000v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0046R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0046R.layout.abc_popup_menu_header_item_layout, listView, false);
    ...
    private android.view.View findParentViewForSubmenu(@android.support.annotation.NonNull android.support.p000v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, @android.support.annotation.NonNull android.support.p000v7.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
        ...
        L_0x000a:
            ...
            r4 = r6
            android.support.v7.view.menu.MenuAdapter r4 = (android.support.p000v7.view.menu.MenuAdapter) r4
            goto L_0x0029
        L_0x0025:
            r5 = 0
            r4 = r3
        ...
        L_0x0055:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v7.view.menu.CascadingMenuPopup.findParentViewForSubmenu(android.support.v7.view.menu.CascadingMenuPopup$CascadingMenuInfo, android.support.v7.view.menu.MenuBuilder):android.view.View");
    }
