...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0046R.C0048id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0046R.C0048id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0046R.C0048id.action_bar));
        }
    }
