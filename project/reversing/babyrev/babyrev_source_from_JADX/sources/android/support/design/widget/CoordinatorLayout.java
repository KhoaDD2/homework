...
import android.support.coordinatorlayout.C0011R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0011R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0011R.styleable.CoordinatorLayout, 0, C0011R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0011R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        int keylineArrayRes = a.getResourceId(C0011R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0011R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r36, int r37) {
        /*
            ...
            int r12 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r35)
            r0 = 1
        ...
        L_0x0022:
            ...
            boolean r4 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r35)
            if (r4 == 0) goto L_0x004b
            goto L_0x004c
        L_0x004b:
            r0 = 0
        ...
        L_0x007a:
            ...
            int r1 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r1, r12)
            r1 = r1 & 7
            r25 = r2
            r2 = 3
        ...
        L_0x00d5:
            ...
            boolean r2 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r21)
    ...
    public static abstract class Behavior<V extends View> {
        ...
        @FloatRange(from = 0.0d, mo115to = 1.0d)
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(@NonNull Context context, @Nullable AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0011R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0011R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0011R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0011R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0011R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0011R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0011R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0011R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0011R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
        ...
        public boolean dependsOn(android.support.design.widget.CoordinatorLayout r2, android.view.View r3, android.view.View r4) {
            /*
                ...
                int r0 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r2)
