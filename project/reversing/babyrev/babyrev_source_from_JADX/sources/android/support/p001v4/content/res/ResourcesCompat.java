...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r19, android.content.res.Resources r20, android.util.TypedValue r21, int r22, int r23, @android.support.annotation.Nullable android.support.p001v4.content.res.ResourcesCompat.FontCallback r24, @android.support.annotation.Nullable android.os.Handler r25, boolean r26) {
        ...
        L_0x0026:
            return r16
        L_0x0027:
            android.graphics.Typeface r7 = android.support.p001v4.graphics.TypefaceCompat.findFromCache(r9, r11, r12)
        ...
        L_0x0032:
            return r7
        L_0x0033:
            java.lang.String r0 = r15.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00d1, IOException -> 0x00b4 }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x00d1, IOException -> 0x00b4 }
            if (r0 == 0) goto L_0x0091
            android.content.res.XmlResourceParser r0 = r9.getXml(r11)     // Catch:{ XmlPullParserException -> 0x008a, IOException -> 0x0083 }
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = android.support.p001v4.content.res.FontResourcesParserCompat.parse(r0, r9)     // Catch:{ XmlPullParserException -> 0x008a, IOException -> 0x0083 }
            r17 = r1
            if (r17 != 0) goto L_0x0063
            java.lang.String r1 = "ResourcesCompat"
            java.lang.String r2 = "Failed to find font-family tag"
            android.util.Log.e(r1, r2)     // Catch:{ XmlPullParserException -> 0x005e, IOException -> 0x0059 }
            if (r13 == 0) goto L_0x0058
            r13.callbackFailAsync(r8, r14)     // Catch:{ XmlPullParserException -> 0x005e, IOException -> 0x0059 }
        L_0x0058:
            return r16
        L_0x0059:
            r0 = move-exception
        ...
        L_0x0063:
            ...
            r10 = -3
            r8 = r26
            android.graphics.Typeface r1 = android.support.p001v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x007f, IOException -> 0x007b }
            return r1
        L_0x007b:
            r0 = move-exception
            r1 = r19
        ...
        L_0x0091:
            ...
            r10 = -3
            r1 = r19
            android.graphics.Typeface r0 = android.support.p001v4.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r9, r11, r15, r12)     // Catch:{ XmlPullParserException -> 0x00b2, IOException -> 0x00b0 }
            r7 = r0
            if (r13 == 0) goto L_0x00af
            if (r7 == 0) goto L_0x00a3
            r13.callbackSuccessAsync(r7, r14)     // Catch:{ XmlPullParserException -> 0x00ab, IOException -> 0x00a7 }
            goto L_0x00af
        L_0x00a3:
            r13.callbackFailAsync(r10, r14)     // Catch:{ XmlPullParserException -> 0x00ab, IOException -> 0x00a7 }
            goto L_0x00af
        L_0x00a7:
            r0 = move-exception
        L_0x00a8:
