...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008d, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p001v4.provider.FontsContractCompat.C01313());
     */
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo121to = 1000) int weight, boolean italic, int resultCode) {
