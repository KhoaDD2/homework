...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int resid) {
        ...
        context.getTheme().resolveAttribute(C0258R.attr.alertDialogTheme, outValue, true);
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @StyleRes int themeResId) {
            this.f12P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, themeResId)));
        ...
        public Builder setTitle(@StringRes int titleId) {
            AlertController.AlertParams alertParams = this.f12P;
        ...
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, boolean[] checkedItems, DialogInterface.OnMultiChoiceClickListener listener) {
            AlertController.AlertParams alertParams = this.f12P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(itemsId);
            AlertController.AlertParams alertParams2 = this.f12P;
