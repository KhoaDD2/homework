...
import android.support.coordinatorlayout.C0223R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0223R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0223R.styleable.CoordinatorLayout, 0, C0223R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0223R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        int keylineArrayRes = a.getResourceId(C0223R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0223R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(@NonNull Context context, @Nullable AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0223R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0223R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0223R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0223R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0223R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0223R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0223R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0223R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0223R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
